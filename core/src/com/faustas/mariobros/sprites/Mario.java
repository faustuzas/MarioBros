package com.faustas.mariobros.sprites;
...
public class Mario extends Sprite {
    ...
    void die() {
        ...
        if (!isDead()) {
            ...
            filter.maskBits = Bits.NOTHING_BIT;
    ...
    private void defineMario() {
        defineMario(32 / Config.PPM, 32 / Config.PPM, false);
    }

    private void defineMario(float positionX, float positionY, boolean big) {
        ...
        fdef.filter.categoryBits = Bits.MARIO_BIT;
        ...
        fdef.filter.categoryBits = Bits.MARIO_HEAD_BIT;
        fdef.shape = head;
        fdef.isSensor = true;
    ...
    private void redefineMario() {
        ...
        defineMario(position.x, position.y, false);
    ...
    private void defineBigMario() {
        ...
        defineMario(position.x, position.y, true);
